...
SECRET_KEY = 'django-insecure-p%xc@zm3j7(je5174ic^1tvv^8%b4c2b)87r!r$z3g+*7fz(bc'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True 
#debug com valor True usado para desenvolvimento
#debug igual a False usado para produção
